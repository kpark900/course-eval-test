...
"""
This script processes Templates 1, 2, and 3 accumulatively. It first calculates and saves the Core Metrics (Template 1), then proceeds to calculate and save the Group Code Metrics (Template 2), and finally calculates and saves the Course Rankings (Template 3).
...
print("Setup, preprocessing, and Templates 1, 2 & 3 processing completed. Normalized data and templates saved.")
